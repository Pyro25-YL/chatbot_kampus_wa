...
const TUTORIAL_DETAILS = {
    kelas: [
        ...
        'Gunakan untuk set & cek default kelas di grup.',
        '- 🎓 *!setkelas 2025A* (admin, simpan default kelas)',
        '- ℹ️ *!kelas* (cek default kelas grup)',
        'Contoh: !setkelas 2025B'
    ],
    jadwal: [
        '📘 PANDUAN KATEGORI: JADWAL',
        'Cek jadwal dengan default kelas atau isi manual.',
        '- 📅 *!jadwal [kelas]* (jadwal lengkap)',
        '- ⏰ *!jadwalb [kelas]* (jadwal besok)',
        '- 🧾 *!jadwalujian [quiz|uts|uas|praktikum|lainnya]*',
        '- 🧾 *!ringkas [hari|pekan]*',
        '- 🗂️ *!listmatkul KELAS* (daftar matkul)',
        '- 🔎 *!cari jadwal KATA*',
        'Contoh: !jadwal 2025A'
    ],
    tugas: [
        '📘 PANDUAN KATEGORI: TUGAS',
        'Pantau tugas aktif & deadline.',
    ...
    pj: [
        '📘 PANDUAN KATEGORI: PJ',
        'Gunakan untuk cek PJ & konfirmasi kuliah.',
    ...
    dosen: [
        ...
        'Cari dosen & jadwal mengajar.',
        '- 🧑‍🏫 *!dosenall* (semua dosen & jadwal)',
        '- 📅 *!dosenbesok NAMADOSEN* (jadwal besok, bisa nama depan)',
        '- 🏫 *!dosenkelas [kelas|semua]* (daftar dosen per kelas)',
        'Contoh: !dosenbesok harmon'
    ]
};

const TUTORIAL_ALLOWED = new Set(['kelas', 'jadwal', 'tugas', 'pj', 'dosen']);
